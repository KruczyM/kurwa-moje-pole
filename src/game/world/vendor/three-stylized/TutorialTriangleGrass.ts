    ...
    const mat = new THREE.ShaderMaterial({
      ...
      vertexShader: `
        ...
        void main() {
          ...
          if (cov <= 0.01) {
            // Zwin wierzcholek poza widok na drogach i wydeptanych szlakach
      ...
      fragmentShader: `
        ...
        void main() {
          ...
          vec3 light = vec3(0.095, 0.320, 0.105); // Wierzcholki oswietlone sloncem
