...
function createDistantGeometry(count: number, extent = 58.5): THREE.BufferGeometry {
...
/** Low-detail full-map layer: fills the horizon while the moving tile layer is dense near the player. */
    ...
    const m = new THREE.ShaderMaterial({
      ...
      vertexShader: `
        ...
        void main() {
          ...
          float h = 0.14 + fract(sin(dot(position.xz, vec2(12.9898, 78.233))) * 43758.5) * 0.22;
          q += aYaw * side * 0.007;
          q.y += tip * h;
